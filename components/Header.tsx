  ...
  return (
    <header className="flex items-center justify-between px-10 py-8 border-b-4 border-[#30363d] bg-[#0d1117] relative overflow-hidden">
      ...
      <div className="flex items-center gap-6 z-10">
        ...
        >
          <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1 group-hover:text-red-500 transition-colors">Get the game!</span>
          <div className="flex items-center gap-3 bg-red-600/10 border border-red-600/30 px-4 py-1.5 group-hover:bg-red-600 group-hover:border-white/20 transition-all">
            ...
            <span className="text-[11px] font-black text-red-500 uppercase tracking-widest group-hover:text-white transition-colors underline decoration-red-500/30 group-hover:decoration-white/30 underline-offset-4">TRAINSLATION STEAM PAGE</span>
          </div>
        </a>
      </div>
