                ...
                <div className="flex-1 flex items-center gap-2">
                  ...
                  {wid && (
                    <button 
                      ...
                      className="w-12 h-12 flex items-center justify-center bg-slate-900 border-2 border-slate-800 text-slate-500 hover:text-red-500 hover:border-red-500 transition-all shrink-0"
                    >
