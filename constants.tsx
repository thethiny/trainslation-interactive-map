...
const stations: Station[] = [
  ...
  { id: 'GB1', name: 'GB1', line: ['green', 'blue'], x: 680, y: 210, isTransfer: true },
  { id: 'G4', name: 'G4', line: ['green'], x: 710, y: 280, isTransfer: false },
  { id: 'GR1', name: 'GR1', line: ['green', 'red'], x: 610, y: 420, isTransfer: true },
  { id: 'G5', name: 'G5', line: ['green'], x: 450, y: 390, isTransfer: false },
  { id: 'G6', name: 'G6', line: ['green'], x: 320, y: 260, isTransfer: false },
  { id: 'GR2', name: 'GR2', line: ['green', 'red'], x: 240, y: 260, isTransfer: true },
  { id: 'GB2', name: 'GB2', line: ['green', 'blue'], x: 80, y: 230, isTransfer: true },
  ...
  // GR1 Here
  { id: 'R4', name: 'R4', line: ['red'], x: 590, y: 540, isTransfer: false },
  ...
  // BY2 Here
  { id: 'Y1', name: 'Y1', line: ['yellow'], x: 190, y: 230, isTransfer: false },
  // RY2 Here
  { id: 'Y2', name: 'Y2', line: ['yellow'], x: 390, y: 200, isTransfer: false },
  // BY1 Here
  { id: 'Y3', name: 'Y3', line: ['yellow'], x: 530, y: 340, isTransfer: false },
  { id: 'Y4', name: 'Y4', line: ['yellow'], x: 530, y: 490, isTransfer: false },
  { id: 'Y5', name: 'Y5', line: ['yellow'], x: 390, y: 520, isTransfer: false },
  // RY1 Here
  { id: 'Y6', name: 'Y6', line: ['yellow'], x: 140, y: 520, isTransfer: false },
